...
4 - Delete			Exec sp_DeleteGiaoVien 1
*/
...
2 - Insert			Exec sp_InsertCauHoi 1,1,'Minh 1','01/11/1993',1,'01/11/2003','',1,'cmnd1'
3 - Edit				Exec sp_UpdateGiaoVien 6,3,2,'Minh Thuy','01/11/1993',1,'01/11/2003',2,1,'cmnd100'
4 - Delete			Exec sp_DeletePhanQuyen 3
*/
...
CREATE PROC sp_InsertCauHoi(@MaGV int, @MaBD int, @MaBM int, @NoiDung varchar(255), @ThangDiem int, @MucDo int, @LuaChon BIT, @Ngaytao date,
...
CREATE PROC sp_UpdateCauHoi(@MaGV int, @MaBD int, @MaBM int, @NoiDung varchar(255), @ThangDiem int, @MucDo int, @LuaChon BIT, @Ngaytao date,
								  @TrangThai BIT, @Thutu int)
AS
	BEGIN
		IF(@NoiDung = '')
